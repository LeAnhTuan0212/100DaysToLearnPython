...
# Prints a string into th console, asks the user for a string input. 
...
# Floats are numbers with decimal places. When you do calculation that results in a fraction 
# e.g 4/3 the results will always be a floating point number.
my_float = 3.14159

# Strings
# A string is just a string of characters. It shoulds be surrounded by double quotes.
my_string = "Hello"
...
# The += Operator
# This is a convenient way to modfy a variable. It takes the existing value in variable and adds to it.
# You can also use any of the other mathematical operators e.g. -= or *=
my_number = 4
my_number += 2 # result is 6

# The Module Operator
# Often you'll want to know what is the remainder after a divsion
# e.g. 4 / 2 = 2 with no remainder but 5 / 2 = 2 with 1 remainder
# The modulo does not give you the result of the division, just the remainder. It can be really helpful in certain situations, 
# e.g. figuring out if a number is odd or even.
5 % 2 # result is 1

# Syntax Error
# Syntax errors happen when your code does not make any sense to computer. This can happen because you've misspelt something 
# or there's to many brackets or a missing comma.
# print(12 + 4)) # SyntaxError: unmatched ')'

# Name Error
# This happens when there is a variable with a name that the computer does not recognise. It's usually because 
# you've misspelt the name of a variable you created earlier.
...
# Zero Division Error
# This happens when you try ti divide by zero. This is something that is mathematically impossible so Python will also complain.
# 5 % 0
# ZeroDivisionError: integer division or modulo by zero

# Creating Functions
# This is the basic syntax a function in Python. It allows you to give a set of instructions a name, 
...
# Calling Functions 
# You activate the function by calling it. This is simply done by writing the name of the function followed by a set of round brackets. 
# This is allows you to determine when to trigger the function and how many times.
my_function()
my_function()
...
# depending on the input. It makes your function more useful and re-useable.
def add(n1, n2):
    print(n1 + n2)
add (2, 3)

# Function with Outputs 
# In addition to input, a function can also have an output. The output value is proceeded by keyword "return".
# This allow you to store the result from a function.
def add_(n1, n2):
    return n1 + n2
result = add_(2, 3)
...
# break
'''
This keyword allows you to break free of the loop. 
...
# Class Properties 
'''
You can create a variable in init() of
